function [Mdl,accuracy0,sensitivity0,specificity0,precision0,gmean0,f1score0,ytrue,yfit,C]=Test_Training_LR(Combine_TR,Combine_TS)
% %%% ####################################### 
[M,N]=size(Combine_TR);
...
[accuracy0,sensitivity0,specificity0,precision0,gmean0,f1score0,C1]=prediction_performance(testing_set.class, yfit);
