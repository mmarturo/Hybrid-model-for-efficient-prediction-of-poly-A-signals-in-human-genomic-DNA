function [name_Miers, Miers_Seq_pos, Miers_Seq_neg]=Extract_Miers3(Patern_pos, Patern_neg)
...
for N1=1:4
    for N2=1:4
        for N3=1:4
            ...
            name_Miers{k}=strcat(Necl{N1},Necl{N2},Necl{N3});

            for i=1:M
                for j=1:N-2

                    Mier=[Patern_pos0(i,j), Patern_pos0(i,j+1), Patern_pos0(i,j+2)];
                    ...
                    Mier=[Patern_neg0(i,j), Patern_neg0(i,j+1), Patern_neg0(i,j+2)];
